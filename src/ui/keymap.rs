...
are independent of each other. In the reader there is no list to narrow \u{2014}
finding text inside an article is a different thing \u{2014} so `/` there moves to
